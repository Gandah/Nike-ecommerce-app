  ...
  return (
    <footer className="max-container">
      ...
      <div className="flex flex-col items-start">
            ...
            <p className="text-white-400 mt-6 text-base font-montserrat
            ...
            <div className="flex items-center gap-5 mt-8 ">
              ...
              w-12 aspect-square bg-white rounded-full cursor-pointer transition duration-300 hover:scale-[1.2]" >
                  <img
                    src={icon.src}
                    alt={icon.alt}
                    width={24}
      ...
      {section.links.map((link) => (
        ...
        text-base leading-normal hover:text-slate-gray hover:cursor-pointer">
            <a>{link.name}</a>
          </li>
      )
